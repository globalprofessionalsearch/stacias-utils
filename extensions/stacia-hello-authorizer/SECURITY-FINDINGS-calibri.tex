...
\usepackage{fontspec}
% Calibri via Carlito, its metric-compatible open clone (Calibri itself is
% proprietary and not installed). Explicit Path so it resolves under both
% xelatex and lualatex regardless of fontconfig registration.
\setmainfont{Carlito}[
